            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="<?= $menu['tab_master']; ?>">
                    ...
                    <ul id="masterinfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="<?= base_url('admin/absensi') ?>" class="<?= $menu['absensi']; ?>"><i class="icon-date_range"></i>Data Presensi</a></li>
                        <li><a href="<?= base_url('admin/pengaturan_absen') ?>" class="<?= $menu['pengaturan_absen']; ?>"><i class="icon-settings1"></i>Pengaturan Presensi & Gaji</a></li>
