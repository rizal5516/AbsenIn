        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="mb-1 <?= $menu['tab_home']; ?>" id="home-tab">
                    <a href="<?= base_url('pegawai/index') ?>" class="iq-waves-effect" <?= $menu['dashboard']; ?> aria-expanded="true"><span class="ripple rippleEffect"></span><i class="icon-laptop iq-arrow-left"></i><span>Dashboard</span><i class="iq-arrow-right"></i></a>
                </li>

                <li class="<?= $menu['tab_master']; ?>">
                    <a href="#userinfo" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span class="ripple rippleEffect"></span><i class="icon-database iq-arrow-left"></i><span>Data
