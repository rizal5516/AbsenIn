        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="active mb-1">
                    <a href="<?= base_url('pegawai/index') ?>" class="iq-waves-effect" data-toggle="collapse" aria-expanded="true"><span
                ...
                <li>
                    ...
                    <ul id="userinfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="<?= base_url('pegawai/dataAbsensi') ?>"><i class="icon-date_range"></i>Data Absen</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
            ...
            <ul class="navbar-list">
                <li class="line-height">
                    <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                        <img src="<?= base_url() ?>/assets/img/pegawai/default.jpg" class="img-fluid rounded mr-3"
                            alt="user">
                        <div class="caption">
                            <h6 class="mb-0 line-height">User</h6>
                            <p class="mb-0">User</p>
                        </div>
                    </a>
