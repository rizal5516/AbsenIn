                                            ...
                                            <tr>
                                                <td><img src="<?= base_url('assets/img/pegawai'); ?>/<?= $p->gambar; ?>" alt="pegawai" class="img-fluid rounded mr-2 mb-4" width="50px">
                                                    <div class="d-inline-block">
                                                        ...
                                                        <p class="text-muted">NIP: #<?= $p->nip; ?></p>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_url('gaji/detailKehadiran'); ?>/<?= $p->id_pegawai; ?>" class="btn iq-bg-info btn-rounded btn-sm my-0 mr-2">
                                                        <i class="icon-open_in_new"></i>Detail Kehadiran</a>
                                                    <a href="<?= base_url('gaji/riwayatPenggajian'); ?>/<?= $p->id_pegawai; ?>" class="btn iq-bg-primary btn-rounded btn-sm my-0 mr-2">
                                                        <i class="icon-open_in_new"></i>Riwayat Gaji</a>
                                                </td>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                            </tr>
