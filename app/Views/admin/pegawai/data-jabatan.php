                                    ...
                                    <?php if ($jabatan != null) : ?>
                                        ...
                                        foreach ($jabatan as $j) : ?>
                                            <tr>
                                                ...
                                                <td><?= $j->id_jabatan; ?></td>
                                                <td>
                                                    <a href="javascript:void(0);" class="table-remove btn-edit" data-placement="top" data-original-title="Edit" data-id_jabatan="<?= $j->id_jabatan; ?>" data-nama_jabatan="<?= $j->nama_jabatan; ?>"><button class="btn iq-bg-primary btn-rounded btn-sm my-0" data-toggle="modal" data-target="#jabatanModal">
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <form action="<?= base_url('admin/edit_jabatan'); ?>" method="POST" class="text-center mt-4">
                                <!-- fieldsets -->
                                <fieldset>
